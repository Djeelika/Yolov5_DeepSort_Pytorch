...
if __name__ == '__main__':
    ...
    parser.add_argument('--deep_sort_model', type=str, default='osnet_x0_25') # МАЛЕНЬКАЯ МОДЕЛЬ, но быстро работает
    # parser.add_argument('--source', type=str, default='0', help='source')  # файл/папка, 0 для веб-камеры
    parser.add_argument('--source', type=str, default='video/NightHighway.mp4', help='source')  # ВИДЕО - ФАЙЛ 
